Connection API
==========
>**Guidance**: this API is typically only needed for Embedded Integration development where you want to expose a form in your application's UI to collect a user's credentials to the application being integrated, and then use the virtual export and import APIs below, or persisted exports and imports that would also be created via API, to get data in and out of the integrated application.
